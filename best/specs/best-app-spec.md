...
매치 행은 `is_ad=true` 로 **저장**하고(하드 삭제 안 함) 리더가 항상 제외한다. 2026-07-10 실측: 2,053건 중 광고 60건, 표시 대상 잔존 0건.
...
로그인 → 홈 렌더(2,053건) · 기간 탭(일 1,865 < 주 2,288) · 커뮤 토글 · 전체 해제 빈 상태 · 더보기(100→200) ·
검색(제목 41건 전부 매치 / 커뮤명 100건 전부 clien / 판명 '스퀘어'·'싱갤'·'신유머' / 0건 상태) ·
저장·읽음·배지·정렬 3종 · 새로고침 후 서버 복원 · 광고 행 부재 · 9개 커뮤 원문 링크 전부 HTTP 200 도달.
