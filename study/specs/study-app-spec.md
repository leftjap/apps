...
| 발화 패턴 | lang | 생성 분량 | 비고 |
|---|---|---|---|
| "오늘 공부하자" / "공부 만들어줘" | 양쪽 (en + ja) | 각 lang 5문장 | 미지정 시 default |
| "영어공부" / "오늘 영어" / "오늘 영어 N문장" | en | N (default 10) | 숫자 명시 시 그 만큼 |
| "일본어공부" / "오늘 일본어" / "오늘 일본어 N문장" | ja | N (default 10) | 숫자 명시 시 그 만큼 |
| "이번 주 5일치 영어" | en | 일자별 10×5=50 | 5일치 batch |
| "오늘 콘텐츠 비워줘" | 양쪽 | 0 (DELETE) | 잘못 생성 시 reset |

**기본 절차 (단일 lang · 단일 일자 기준 · trigger 1회당):**

1. **lang / 일자 / 분량 결정**
   - 사용자 발화에서 추출 (없으면 default: lang=발화 언어 추론, date=오늘 ISO, count=10)
