...
### 8-3. 신규 레슨 카드
- 카드 표시: 문장, 읽기(일본어), 의미
- **미니대화 블록 (2026-09-08, 카드 위)**: `explanation.miniDialogue`(2~4턴) 가 있으면 카드 위에 "이런 대화에서" 블록 — 전체 듣기·한 줄 듣기·타깃 줄 강조·한글 병기. 맥락 입력 전용이라 녹음·판정·잠금 없음. 복습 화면에는 없음. 정본 `docs/explanation-schema.md §miniDialogue`
- 카운터: "신규 N / total"
- 오디오 재생 버튼 (Azure TTS)
- "따라 말하기" 발음 연습 버튼
- 해설 패널 (접기/펼치기):
