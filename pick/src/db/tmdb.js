...
// TMDB 검색은 한글 띄어쓰기에 민감(2026-07 실측). 관찰상 질의를 공백으로 토큰화해 제목 토큰과
// prefix 정렬하는 식으로 동작: "세븐 킹덤의 기사"(3토큰)는 제목 "세븐킹덤의 기사"(2토큰)와 정렬 실패
// → 0건. 공백 하나만 지운 "세븐킹덤의 기사"는 매칭 ✓. 공백을 전부 지우면 첫 토큰을 초과해 오히려 0건.
