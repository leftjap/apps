...
const KEYWORD_RULES = Object.freeze({
  delivery: ['쿠팡이츠','주식회사우아','우아한형제들','우아한형','배달의민족','요기요'],
  subscribe: ['lg전자구독료','disneyplus','디즈니플러스','구글페이먼트','쿠팡(와우멤','네이버플러스','주식회사티빙','에스케이텔레','sk텔레콤','sk통신료','배민클럽','에스케이플래','넷플릭스','멜론','스포티파이','애플뮤직','유튜브','구글플레이','통신'],
  ...
  culture: ['caromclub','옵티머스캐롬','우리당구장','뉴코인싱어노','교보문고','당구','노래방','코인싱어','영풍','알라딘','예스24','영화','cgv','메가박스','롯데시네마','공연','전시','뮤지컬','현대음률','땡스북스','밀리의서재','인터파크트리플','화담숲','스토리엠','뮤비존','디즈니플러스','놀유니버스','수상한사진관','배재학당','국가유산청','와이비엠'],
