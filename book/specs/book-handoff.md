...
- **남은 placeholder 2권**:
  ...
  - **book_095** ⚠ **오염 entry(여러 책 혼재)** — 어구록 21건이 ① 홍세화(김학철 "편하게 살려거든 불의를 외면하라" 유언) ② 영어학습서(액션 페이킹·부지런한 겁쟁이·요일별 루틴) ③ 회의주의(미신·마이클 셔머) ④ 밀/건강(진화) ⑤ 사유 세계 등 **≥5개 다른 책**에서 옴. 단일 저자로 못 고침 → **어구록별 book_ref 분할 필요(Supabase 라이브 레코드 수정)**. 큰 작업이라 사용자와 방식 협의 후 진행 권장.
