...
- **남은 것 [P1-D 잔여]**: placeholder 6권은 Aladin 매칭 실패(표지無) → 사용자 정보 필요. book_025 `분노사회`/한병철(한병철 저작 아님 확정), book_066 `가진 돈을 몽땅 써라`/빌 퍼킨스(Aladin엔 호리에 다카후미 "…은 몽땅"; 빌 퍼킨스는 *Die With Zero*) 등 책 자체 모호. book_002·053·093·095 검색무결과.
